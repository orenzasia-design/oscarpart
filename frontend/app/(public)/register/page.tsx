      ...
      <div className="min-h-screen bg-surface flex items-center justify-center px-4">
        <div className="card max-w-md w-full text-center py-10">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-4">
            Data perusahaan Anda telah kami terima. Tim OSCARPART akan mereview dalam <strong className="text-gray-700">1x24 jam kerja</strong>.
          </p>
          <div className="bg-brand-50 border border-brand-100 rounded-xl p-4 text-left mb-6">
            ...
            <ul className="text-xs text-brand-600 space-y-1">
              ...
              <li>✓ Anda bisa login dan akses harga dan stok lengkap</li>
            </ul>
          </div>
          <p className="text-xs text-gray-400 mb-3">Butuh akses lebih cepat? Hubungi kami:</p>
          
            href="https://wa.me/6288802032033?text=Halo%20OSCARPART%2C%20saya%20baru%20mendaftar%20dan%20ingin%20konfirmasi%20akun."
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-green-500 hover:bg-green-600 text-white font-semibold px-5 py-2 rounded-lg text-sm mb-3"
          >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input {...register('website')} type="text" placeholder="https://www.perusahaan.com" className="input" />
                <p className="text-xs text-gray-400 mt-1">Kosongkan jika tidak ada</p>
              </div>
            </div>
            <div className="section-title mt-6">Data Kontak PIC</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {field('full_name',      'Nama Lengkap PIC *', 'text', { placeholder: 'Nama sesuai KTP' })}
              {field('contact_person', 'Nama Kontak *', 'text', { placeholder: 'Bisa sama dengan nama lengkap' })}
